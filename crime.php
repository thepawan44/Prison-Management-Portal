...
<form action="includes/crime.inc.php" method="post" onsubmit = "return validate()">
    ...
    <div class="lg:w-1/2 md:w-2/3 mx-auto">
      <div class="flex flex-wrap -m-2">
        ...
        <div class="p-2 w-1/2">
          ...
          <div class="mt-1 relative rounded-md shadow-sm">
            <input
            name="date_in" class="w-full bg-gray-100 rounded border border-gray-400 focus:outline-none focus:border-indigo-500 text-base form-input block w-full px-3 h-10"
              type="date"
            />
          </div>
        </div>
